...
/**
 * A Map with additional utility methods. This is used throughout Typescript/Javascript Discord libraries rather than Arrays for anything that has
...
class Collection extends Map {
     ...
     */
    array() {
        if (this._array?.length !== this.size)
     ...
     */
    keyArray() {
        if (this._keyArray?.length !== this.size)
